...
当前分支已完成 Phase 0 工程骨架、Phase 1 首个纵向闭环和 Phase 2 日期与 Today 能力，并提前实现了重要性/紧急性分类的基础能力：
...
项目、标签、软删除、组合筛选与排序、设置和备份恢复等仍按 `docs/05-technical-design.md` 的后续阶段开发。任务详情中的项目与标签字段将在 Phase 3 补齐。
